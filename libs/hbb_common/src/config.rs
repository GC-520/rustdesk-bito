...
pub const RENDEZVOUS_SERVERS: &[&str] = &["www.bitorobotics.com"];
pub const RS_PUB_KEY: &str = "5ztyhJ5mKQ4zvmYvFxPlOsmb6O1NA7P6sUH0fVc4QBM=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "bitorobotics".to_string() // 用户设置的固定密码
    }
